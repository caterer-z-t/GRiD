...
GRiD has been applied to >50,000 study participants with whole-genome sequencing data from multiple TOPMed cohorts [@taliun2021sequencing] and 1000 Genomes Project [@auton2015global] , comprising participants across continental populations of African, European, and American ancestry (including self-reported Hispanic/Latino individuals and individuals with indigenous American genetic ancestry). These analyses form the basis of ongoing research manuscripts and demonstrate the applicability of GRiD to population-scale analyses and heterogeneous sequencing datasets.
...
**Coverage estimation.** Following Mukamel et al. [@mukamel2021, Supplemental Materials, Section 2], weighted mean depth across the VNTR region from mosdepth [@pedersen2018] bins is computed as:
...
We are deeply indebted to Drs. Po-Ru Loh and Margaux Hujoel for sharing code and providing additional technical support. We would additionally like to thank Dr. Akshay Avvaru for his help and support, and Dr. Daniel Larremore for his careful review and for catching several typos before they could escape into the wild. This work was supported by NIH K01: HL157658, R01: HL172887 and NSF: 2022138 grants. The funders had no role in the design, development, analysis, or preparation of this work.
